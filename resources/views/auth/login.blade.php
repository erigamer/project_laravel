            ...
            <div class="card-body p-4">
                ...
                <form> @csrf
                    <div class="form-group mt-4">
                        ...
                        form-control-lg" name="email" required value="{{ old('email') }}">                         
                ...
                <p class="mt-2 text-center">Belum punya akun? <a href="{{ route('auth.register') }}" style="text-decoration: none">Ayo buat akun!</a>
                </p>
                <p class="mt-2 text-center">balek <a href="{{ route('views.home') }}" style="text-decoration: none">balek!</a>
                </p>
            </div>
        </div>
    </div>
